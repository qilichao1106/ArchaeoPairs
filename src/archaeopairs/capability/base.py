...
class VLM(Protocol):
    def classify(self, *, image_ref: str, caption: str | None, trace_id: str) -> dict: ...
    def diagnose(self, *, image_ref: str, context: dict, trace_id: str) -> dict: ...
    def confirm_text(self, *, artifact_id: str, text: str, context: dict, trace_id: str) -> dict: ...
